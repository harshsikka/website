> **⚠️ DRAFT — NOT LEGAL ADVICE.** Structure/tone modeled on a peer lab's privacy notice; uses category-based language (no named vendors) and a US / California (CCPA) "Path B" scope (no cookie-consent banner). Tailored to what fig.inc actually does, including **session-recording analytics** (disclosed generically). `[BRACKETS]` still need your input, and counsel should review — especially the "we do not sell/share" statement (§10) and the Do-Not-Track/GPC stance (§3).
...
**[Fig — FULL LEGAL ENTITY NAME]** ("Fig," "we," "us," or "our") is an artificial intelligence research company. This Privacy Policy (the "Policy") describes how we collect, use, and disclose your information when you access or use our website and blog at fig.inc, or otherwise interact with us (collectively, the "Services"). For purposes of this Policy, Fig is the controller of your information.
